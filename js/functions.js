var engine = {
    "cores": ['green', 'purple', 'pink', 'red', 'yellow', 'grey','black','orange'],
    "hexadecimais":{
        'green':'#02EF00',
        'purple':'#790093',
        'pink':'#F02AFE',
...
const audioMoeda = new Audio('jogo-ingles/audio/moeda.mp3');
const audioErrou = new Audio('jogo-ingles/audio/errou.mp3');
...
function aplicarCorNaCaixa(nomeDaCor){
    ...
    caixaDasCores.style.backgroundImage = "url('jogo-ingles/img/caixa-fechada.png')";
